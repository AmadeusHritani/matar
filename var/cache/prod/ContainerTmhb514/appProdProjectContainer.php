...
class appProdProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('e2l04PYLNZ', 0, ($this->targetDirs[0].'/pools'));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'matar', 'user' => 'matar', 'password' => 'M@sterM@son13i', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), $a, ['enum' => 'string']);
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_9b943e5025a9559226bdaf6241b79605571ad71df09bf38046b41484dd93d014');
    ...
    {
        return $this->services['assets._version__default'] = new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('1.7.8.6', '%s?%s');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('70ITYgnJjXphB34eyEVPQopSoey2UNUWZAXhsAM1QgMhtTrK41Ktdur2s4gpEBoA');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'modules_translation_paths': $value = [
                ...
                54 => ($this->targetDirs[3].'/modules/hooksmanager/translations'),
                55 => ($this->targetDirs[3].'/modules/stripe_official/translations'),
                56 => ($this->targetDirs[3].'/modules/dhldp/translations'),
                57 => ($this->targetDirs[3].'/modules/doofinder/translations'),
                58 => ($this->targetDirs[3].'/modules/usercentrics/translations'),
                59 => ($this->targetDirs[3].'/modules/klarnaofficial/translations'),
                60 => ($this->targetDirs[3].'/modules/izettleconnector/translations'),
                61 => ($this->targetDirs[3].'/modules/ets_blog/translations'),
                62 => ($this->targetDirs[3].'/modules/ph_scrolltotop/translations'),
            ]; break;
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.active_modules' => [
                ...
                69 => 'izettleconnector',
                70 => 'ets_htmlbox',
                71 => 'ets_manufacturerslider',
                72 => 'ets_pres2presfree',
                73 => 'ets_banneranywhere',
                74 => 'ets_whatsapp',
                75 => 'ets_delete_order',
                76 => 'ets_blog',
                77 => 'ph_products_cms',
                78 => 'ets_wishlist_pres17',
                79 => 'ets_testimonial',
                80 => 'ets_securitycertification',
                81 => 'ph_scrolltotop',
            ],
            ...
            'kernel.secret' => '70ITYgnJjXphB34eyEVPQopSoey2UNUWZAXhsAM1QgMhtTrK41Ktdur2s4gpEBoA',
