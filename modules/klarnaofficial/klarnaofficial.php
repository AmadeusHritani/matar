...
class KlarnaOfficial extends PaymentModule
{
    ...
    public function __construct()
    {
        ...
        $this->description = $this->l('This module offers support for the Klarna Checkout product.');
    }
    ...
    public function installTabs()
    {
        ...
        if ((int) $controllerAlreadyExists === 0) {
            $this->createTab(0, $this->l('Klarna OSM Configuration'), 'AdminKlarnaOsmConfiguration');
        }
        
        $controllerAlreadyExists = Tab::getIdFromClassName('AdminKlarnaOrderInfo');

        if ((int) $controllerAlreadyExists === 0) {
            $this->createTab(0, $this->l('Klarna Order Info'), 'AdminKlarnaOrderInfo');
        }
