...
<div class="dtm-right-block">
    <div class="panel data_tab_help">
        ...
        <ul>
            <li>{l s='1. Install "Prestashop Connector" on source website. Download Prestashop Connector module' mod='ets_pres2presfree'}&nbsp;<a target="_blank" href="{$mod_dr_pres2pres|escape:'html':'UTF-8'}plugins/ets_pres2presconnector.zip">{l s='here' mod='ets_pres2presfree'}</a></li>
            ...
            <li>{l s='6. Final tweaks (Clear cache, Regenerate friendly URL, reindex data, recover passwords). Download Prestashop Password Keeper' mod='ets_pres2presfree'}&nbsp;<a target="_blank" href="{$mod_dr_pres2pres|escape:'html':'UTF-8'}plugins/ets_pres2prespwkeeper.zip">{l s='here' mod='ets_pres2presfree'}</a></li>
        </ul>
