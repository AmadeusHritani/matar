...
<div class="dtm-right-block">
    ...
    {/if}
    <form id="module_form" action="{$link->getAdminLink('AdminPresToPresFreeImport')|escape:'html':'UTF-8'}" class="defaultForm form-horizontal" novalidate="" enctype="multipart/form-data" method="post" >
        <input type="hidden" value="{$step|intval}" name="step"/>
        <div id="fieldset_0" class="panel">
            <div class="panel-heading"><i class="icon-import"></i>{l s='Migration' mod='ets_pres2presfree'}</div>
            <ul class="tab_step_data">
                <li class="data_number_step{if $step==1} active{/if}" data-step="1"><span>1</span>{l s='Source' mod='ets_pres2presfree'}</li>
                 <li class="data_number_step{if $step==2} active{/if}" data-step="2"><span>2</span>{l s='Data to migrate' mod='ets_pres2presfree'}</li>
                <li class="data_number_step{if $step==3} active{/if}" data-step="3"><span>3</span>{l s='Migration options' mod='ets_pres2presfree'}</li>
                <li class="data_number_step{if $step==4} active{/if}" data-step="4"><span>4</span>{l s='Review migration' mod='ets_pres2presfree'}</li>
                <li class="data_number_step{if $step==5} active{/if}" data-step="5"><span>5</span>{l s='Process migration' mod='ets_pres2presfree'}</li>
            </ul>
            <div class="form-wrapper data_import_data">
                ...
                <div class="ybc-form-group ybc-blog-tab-step1 {if $step==1} active{/if}">
                    ...
                    {else}
                            ...
                            <div class="col-lg-8">
                                <div class="data_upload_button_wrap">
                                    ...
                                    <div class="data_upload_button">
                                        <input type="text" name="data_upload_button" id="data_upload_button_input" value="{l s='No file selected.' mod='ets_pres2presfree'}" />
                        ...
                        <div class="form-group source url_site">
                            ...
                            <div class="col-lg-8">
                                <input style="width: 100%;" type="text" name="link_site" id="link_site" placeholder="{l s='Eg: http://sourcewebsite.abc/modules/ets_pres2presconnector/connector.php' mod='ets_pres2presfree'}" />
                            </div>
                        </div>
                        <div class="form-group source url_site">
                        ...
                        <p class="link_download_plugin alert alert-info">{l s='Before getting started with the migration, please download' mod='ets_pres2presfree'}&nbsp;<a href="{$mod_dr_pres2pres|escape:'html':'UTF-8'}plugins/ets_pres2presconnector.zip" target="_blank"><b>{l s='Prestashop Connector' mod='ets_pres2presfree'}</b></a>&nbsp;{l s=' module  and install the module on source Prestashop website. This Connector module gives you "Connector URL" and "Secure access token" (or data file) that is required above' mod='ets_pres2presfree'}</p>
                    {/if} 
                </div>
                ...
                <div class="ybc-form-group ybc-blog-tab-step5{if $step==5} active{/if}">
                    <p>{l s='The import has been successfully processed.' mod='ets_pres2presfree'}</p>
                </div>
                    ...
                    <div class="popup_uploading_table">
                        <div class="popup_uploading_tablecell">
                            <div class="popup_uploading_content">
                                {l s='Loading data, please wait...!' mod='ets_pres2presfree'}
            ...
            <div class="panel-footer">
                <button class="btn btn-default pull-right" name="submitImport" value="1" type="submit" >
                    <i class="process-icon-next"></i>{l s='Next' mod='ets_pres2presfree'}
                </button>
                <button class="btn btn-default pull-left" name="submitBack" value="1" type="submit"{if $step==1} disabled="disabled"{/if}>
                    <i class="process-icon-back"></i>{l s='Back' mod='ets_pres2presfree'}
                </button>
