...
use Exception;
use IzettleApi\Client\Image\Exceptions\FileIsNotAnImageException;
use IzettleApi\Client\Image\Exceptions\ImageIsToSmallException;
use IzettleApi\Client\Image\Exceptions\ImageTypeNotAllowedException;
use IzettleApi\Client\Image\Exceptions\MaximumImageFileSizeExcededException;
...
final class ImageFileUpload implements ImageUploadRequestInterface
{
    ...
    private static function validatedImageType($file)//: void
    {
        $type = false;
    ...
    private static function validateImageSize($file)//: void
    {
