...
{*                                    <i class="icon-ban"></i>*}
                        ...
                        <div class="text-center padding-4" style="width: 100%;">
                            ...
                            <aside class="padding-top-4">
                                <p>
                                    <i class="icon-info-circle"></i> {l s='When you export prices, the product prices will contain their specific VAT rate. You can edit VAT in the product editor.' mod='izettleconnector'}
...
<script>
    ...
    $(document).ready(function () {
        ...
        var btnFinish = $('<button id="wizard-import-button" ></button>').html(`{l s='Start sync' mod='izettleconnector'}`)
            ...
            .on('click', function(){ $('#smartwizard').smartWizard('goToStep', 5); });
        btnFinish.hide();
